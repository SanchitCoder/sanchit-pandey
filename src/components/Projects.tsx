  ...
  return (
    <div className={project.featured ? "md:col-span-2" : ""}>
      ...
      >
        ...
        <div className="absolute bottom-4 left-4 flex h-9 w-9 items-center justify-end gap-2 overflow-hidden rounded-full bg-gray-900 pr-2.5 transition-all duration-300 ease-in-out group-hover:w-[168px]">
      ...
      <p className="mt-1 text-[14px] font-semibold text-gray-900 sm:text-[15px]">
        {project.name}
      </p>
      <ul className="mt-2 space-y-1">
        {project.highlights.map((highlight) => (
          <li
            key={highlight}
            className="flex gap-2 text-[12px] leading-snug text-gray-500"
          >
